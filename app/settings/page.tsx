        ...
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-6">
                      ...
                      <div>
                        ...
                        <input
                          ...
                          disabled
                          className="w-full px-4 py-2 bg-gray-100 dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg border border-gray-300 dark:border-gray-600 cursor-not-allowed"
                        />
                      </div>
                      ...
                      <form onSubmit={handlePasswordChange} className="space-y-4">
                        <div>
                          ...
                          <input
                            ...
                            className="w-full px-4 py-2 bg-white dark:bg-gray-700 text-gray-900 dark:text-white rounded-lg border border-gray-300 dark:border-gray-600 focus:ring-2 focus:ring-red-500 focus:border-transparent"
                ...
                <>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Erhalten Sie wichtige Updates und Informationen per E-Mail
                        </p>
                      </div>
                      <button
                        onClick={() => handleNotificationChange('email', !emailNotifications)}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          emailNotifications ? 'bg-red-600' : 'bg-gray-300 dark:bg-gray-600'
                        }`}
                      >
                        <span
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex-1">
                        <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-1">
                          Nachrichten von Recruitern
                        </h3>
                        <p className="text-sm text-gray-600 dark:text-gray-400">
                          Erhalten Sie eine E-Mail, wenn ein Recruiter Ihnen eine Nachricht sendet oder an Ihrem Profil interessiert ist
                        </p>
                      </div>
                      <button
                        onClick={() => handleNotificationChange('recruiter', !recruiterMessages)}
                        className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                          recruiterMessages ? 'bg-red-600' : 'bg-gray-300 dark:bg-gray-600'
                        }`}
                      >
                        <span
                          className={`inline-block h-4 w-4 transform rounded-full bg-white transition-transform ${
                            recruiterMessages ? 'translate-x-6' : 'translate-x-1'
                          }`}
                        />
                      </button>
                    </div>
                    ...
                    <div className="p-4 bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded-lg">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="text-sm text-gray-700 dark:text-gray-300">
                          ...
                          <p>
                            Stellen Sie sicher, dass Ihre E-Mail-Adresse korrekt ist, um keine wichtigen Nachrichten von Recruitern zu verpassen.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              {activeTab === 'account' && (
                <>
                  <div className="border-b border-gray-200 dark:border-gray-700 p-6">
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                      Verwalten Sie Ihr Konto oder löschen Sie es
                    </p>
                  </div>
                  ...
                  <div className="p-6 space-y-6">
                    ...
                    <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
                      ...
                      <div className="space-y-2 text-sm">
                        <p className="text-gray-600 dark:text-gray-400">
                          <span className="font-medium">E-Mail:</span> {session?.user?.email || 'Nicht angemeldet'}
                        </p>
                        <p className="text-gray-600 dark:text-gray-400">
                          <span className="font-medium">Kontotyp:</span> {session?.user?.role || 'Gast'}
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="border border-orange-300 dark:border-orange-700 rounded-lg p-6">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        Ihr Profil wird ausgeblendet und Sie können sich nicht mehr anmelden. Sie können Ihr Konto jederzeit wieder aktivieren.
                      </p>
                    ...
                    <div className="border border-red-300 dark:border-red-700 rounded-lg p-6">
                      ...
                      <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        Diese Aktion kann nicht rückgängig gemacht werden. Alle Ihre Daten, Videos und Nachrichten werden dauerhaft gelöscht.
                      </p>
                    ...
                    <div className="p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                      <div className="flex items-start space-x-3">
                        ...
                        <div className="text-sm text-gray-700 dark:text-gray-300">
                          <p className="font-medium mb-1">Warnung:</p>
                          <p>
                            Das Löschen Ihres Kontos ist endgültig. Stellen Sie sicher, dass Sie alle wichtigen Daten gesichert haben.
                          </p>
                        </div>
                      </div>
                    </div>
              ...
              )}ame="text-gray-900 dark:text-white font-medium">Beispieltext</p>
