...
export const authOptions: NextAuthOptions = {
  // NOTE: PrismaAdapter should NOT be used with CredentialsProvider
  // Using both can allow sessions to be created without going through the authorize() function
  // which bypasses our email verification check. For credentials-based auth, we don't need an adapter.
  providers: [
    CredentialsProvider({
      name: 'Credentials',
      credentials: {
