...
import { PaintBucket, Save, Loader2, Plus, Trash2, X, ZoomIn, RefreshCcw, Trophy } from "lucide-react";
...
export default function HybridProfileEditPage({ params }: { params: { id: string } }) {
  const { t } = useLanguage();
    ...
    <>
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
        ...
        <div className="mb-4 flex flex-wrap gap-3 items-center">
          {/* ...existing code for BACKGROUND_OPTIONS... */}
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-6">
        ...
        {clubHistory.length === 0 ? (
          ...
          <div className="space-y-4">
            {clubHistory.map((club: any, index: number) => {
              ...
              return (
                <div key={club.id || index} className={`border rounded-lg p-4 ${isInvalid ? "border-red-500 dark:border-red-400 bg-red-50 dark:bg-red-900/10" : "border-gray-300 dark:border-gray-600"}`}>
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <button
                      onClick={() => setClubHistory(clubHistory.filter((_: any, i: number) => i !== index))}
