    ...
    <footer className="bg-gray-900 dark:bg-gray-950 text-gray-300 dark:text-gray-400">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
          {/* About */}
          <div>
            <h3 className="text-white dark:text-gray-100 font-bold text-lg mb-4">Habicht</h3>
            <p className="text-sm">
          ...
          {/* Resources */}
          <div>
            <h3 className="text-white dark:text-gray-100 font-bold text-lg mb-4">Ressourcen</h3>
            <ul className="space-y-2 text-sm">
              <li>
                <a 
          ...
          {/* Social Media */}
          <div>
            <h3 className="text-white dark:text-gray-100 font-bold text-lg mb-4">Folg üs</h3>
            <div className="flex space-x-4">
              <a href="#" className="hover:text-white dark:hover:text-gray-100 transition" aria-label="Facebook">
                <Facebook className="w-6 h-6" />
              </a>
              <a href="#" className="hover:text-white dark:hover:text-gray-100 transition" aria-label="Instagram">
                <Instagram className="w-6 h-6" />
              </a>
              <a href="#" className="hover:text-white dark:hover:text-gray-100 transition" aria-label="Twitter">
                <Twitter className="w-6 h-6" />
              </a>
              <a href="#" className="hover:text-white dark:hover:text-gray-100 transition" aria-label="Youtube">
