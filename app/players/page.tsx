            ...
            <div className="col-span-2 sm:col-span-2 lg:col-span-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-9 sm:pl-10 pr-9 sm:pr-10 py-2.5 sm:py-2 text-sm leading-normal border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-habicht-500 focus:border-transparent bg-white dark:bg-gray-700 dark:text-white placeholder:leading-normal"
